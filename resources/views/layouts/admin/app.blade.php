        ...
        messaging
            ...
            .then(function(token) {
                if (token) {
                    ...
                    console.warn("No FCM token generated. Check for firebase-messaging-sw.js and HTTPS.");
                }
