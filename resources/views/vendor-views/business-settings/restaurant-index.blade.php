                        ...
                        <div class="col-sm-{{ $store->module->module_type != 'food' ? '4' : '6' }}">
                            <div class="">
                                <label class="d-flex justify-content-between switch toggle-switch-sm text-dark"
                                    ...
                                    <span>{{ translate('messages.extra_packaging_charge_amount') }} 
                                        <span class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                            data-original-title="{{ translate('By_enabling_this_status_customers_will_get_the_option_to_choose_an_extra_packaging_charge_while_placing_an_order_for_extra_packaging_offers._Yes:_Extra_packaging_charge_will_be_auto-selected_by_default._No:_Extra_packaging_charge_will_not_be_selected_by_default_and_customers_can_choose_it_manually.') }}">
                                            <img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                alt="{{ translate('By_enabling_this_status_customers_will_get_the_option_to_choose_an_extra_packaging_charge_while_placing_an_order_for_extra_packaging_offers._Yes:_Extra_packaging_charge_will_be_auto-selected_by_default._No:_Extra_packaging_charge_will_not_be_selected_by_default_and_customers_can_choose_it_manually.') }}">
                                        </span>
                                    </span>
                                ...
                                <div class="input-group mt-2">
                                    <input type="text" class="form-control" value="{{ translate('messages.amount') }}" readonly>
                                    ...
                                    <select name="extra_packaging_default" class="form-control">
                                        <option value="0" {{ $store->storeConfig?->extra_packaging_default == false ? 'selected' : '' }}>{{ translate('messages.no') }}</option>
                                        <option value="1" {{ $store->storeConfig?->extra_packaging_default == true ? 'selected' : '' }}>{{ translate('messages.yes') }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
