...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        ...
        return response()->json([
            ...
            'hide_customer_details_on_delivery' => (int) (isset($settings['hide_customer_details_on_delivery']) ? $settings['hide_customer_details_on_delivery'] : 0),
            'hide_customer_email_on_delivery' => (int) (isset($settings['hide_customer_email_on_delivery']) ? $settings['hide_customer_email_on_delivery'] : 0),
            'hide_customer_phone_on_delivery' => (int) (isset($settings['hide_customer_phone_on_delivery']) ? $settings['hide_customer_phone_on_delivery'] : 0),
            'hide_customer_address_on_delivery' => (int) (isset($settings['hide_customer_address_on_delivery']) ? $settings['hide_customer_address_on_delivery'] : 0),
