...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        ...
        return response()->json([
            ...
            // Rider app still consumes legacy config keys.
            // Serve deliveryman-scoped values through legacy names for compatibility.
            'hide_customer_details_on_delivery' => (int) (isset($settings['hide_customer_details_on_delivery_dm']) ? $settings['hide_customer_details_on_delivery_dm'] : (isset($settings['hide_customer_details_on_delivery']) ? $settings['hide_customer_details_on_delivery'] : 0)),
            'hide_customer_email_on_delivery' => (int) (isset($settings['hide_customer_email_on_delivery_dm']) ? $settings['hide_customer_email_on_delivery_dm'] : (isset($settings['hide_customer_email_on_delivery']) ? $settings['hide_customer_email_on_delivery'] : 0)),
            'hide_customer_phone_on_delivery' => (int) (isset($settings['hide_customer_phone_on_delivery_dm']) ? $settings['hide_customer_phone_on_delivery_dm'] : (isset($settings['hide_customer_phone_on_delivery']) ? $settings['hide_customer_phone_on_delivery'] : 0)),
            'hide_customer_address_on_delivery' => (int) (isset($settings['hide_customer_address_on_delivery_dm']) ? $settings['hide_customer_address_on_delivery_dm'] : (isset($settings['hide_customer_address_on_delivery']) ? $settings['hide_customer_address_on_delivery'] : 0)),
