...
class ProviderWiseTaxExport implements  FromView, ShouldAutoSize, WithStyles,WithColumnWidths ,WithHeadings, WithEvents
{
    ...
    {
        return view('rental::file-exports.provider-wise-tax-report', [
            'data' => $this->data,
        ]);
    }
