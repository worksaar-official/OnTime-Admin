...
class AdminTripTaxReportDetailsExport implements  FromView, ShouldAutoSize, WithStyles,WithColumnWidths ,WithHeadings, WithEvents
{
    ...
    public function view(): View
    {
        ...
        //     ]);
        // }
        return view('rental::file-exports.admin-tax-details-report', [
            'data' => $data,
        ]);
    }
