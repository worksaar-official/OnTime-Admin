...
class ProviderTaxExport implements  FromView, ShouldAutoSize, WithStyles,WithColumnWidths ,WithHeadings, WithEvents
{
    ...
    {
        return view('rental::file-exports.provider-tax-report', [
            'data' => $this->data,
        ]);
    }
